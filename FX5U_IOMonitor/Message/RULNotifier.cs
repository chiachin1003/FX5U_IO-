    ...
    public class RULNotifier : IRULNotifier
    {
        ...
        private async void ProcessQueue(object? state)
        {
            ...
            List<string> messages = dueNotifications.Select(q =>
            {
                ...
                return $"{timestamp} - [即時RUL通知] {args.Machine} - {args.Address}：{args.State} 區，Message = {args.RUL:F2}";
            }).ToList();
            ...
            //{
            //    MessageBox.Show(mergedMessage, "Message 即時通知", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //});
