...
{
    public partial class Sawing_Page : Form
    {
        ...
        private void reset_lab_connectText()//更新主頁面連接狀況
        {
            ...
            var machineList = DBfunction.GetMachineIP("Sawing");
            ...
            var existingContext = GetContext("Sawing") as IMachineContext;
        ...
        {
            using (var form = new DisconnectTable("Saw2"))
            {
                form.StartPosition = FormStartPosition.CenterParent;
                form.ShowDialog(this);
            }
