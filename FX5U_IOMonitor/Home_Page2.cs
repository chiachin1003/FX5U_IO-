...
{
    public partial class Home_Page2 : Form
    {
        ...
        private void reset_lab_connectText()//更新主頁面連接狀況
        {
            ...
            //label1.Text = ShowUtilizationRate("Sawing2", RangeChoice.Today) + "%";
            //label3.Text = ShowUtilizationRate("Sawing2", RangeChoice.Yesterday) + "%";
            //label5.Text = ShowUtilizationRate("Sawing2", RangeChoice.ThisWeek) + "%";
            //label7.Text = ShowUtilizationRate("Sawing2", RangeChoice.LastWeek) + "%";
            ...
            label17.Text = DBfunction.GetMachineRowCount("Sawing").ToString();
            label23.Text = DBfunction.Get_Red_number("Sawing").ToString();
            label15.Text = DBfunction.Get_Yellow_number("Sawing").ToString();
            label19.Text = DBfunction.Get_Green_number("Sawing").ToString();
            ...
            machineList = DBfunction.GetMachineIP("Sawing"); // Sawing2
            if (machineList.IP_address == null || machineList.Port == null)
            {
                label12.Text = LanguageManager.Translate("Mainform_IP_Port_none");
                label12.Text = $"IP = {machineList.IP_address}；Port = {machineList.Port} ";
            ...
            if (existingContext != null && existingContext.IsConnected)
            {
                ...
                label21.Text = DBfunction.Get_address_ByBreakdownParts("Sawing", sawingbreakdowm_part).Count.ToString();
            }
            else
            {
            ...
            if (existingContext != null && existingContext.IsConnected)
            {
                ...
                //label10.Text = existingContext.ConnectSummary.connect.ToString();
            }
            else
            {
            ...
            existingContext = GetContext("Sawing2") as IMachineContext;
            if (existingContext != null && existingContext.IsConnected)
            {
                label13.Text = LanguageManager.Translate("Mainform_connect");
                label13.ForeColor = Color.Green;
                label11.ForeColor = Color.Green;
                label11.Text = ToTaipeiString(DBfunction.GetLastDisconnectEndTime("Sawing")) + LanguageManager.Translate("Mainform_lab_connectrecordSuccess");
                label10.Text = existingContext.ConnectSummary.connect.ToString();
            }
            else
            {
                label13.Text = LanguageManager.Translate("Mainform_disconnect");
                label13.ForeColor = Color.Red;
                label11.ForeColor = Color.Red;
                label11.Text = LanguageManager.Translate("Mainform_lab_connectrecordFailedRecord") + DBfunction.GetLastDisconnectNumber("Sawing") + "\n"
                    + ToTaipeiString(DBfunction.GetLastDisconnectStartTime("Sawing")) + "  ";
                label10.Text = "0";
            }
        ...
        private void SwitchLanguage()
        {
            ...
            btn_Saw.Text = LanguageManager.Translate("Mainform_SawInfo");
            ...
            label8.Text = LanguageManager.Translate("Mainform_lab_lastweek");
            label6.Text = LanguageManager.Translate("Mainform_lab_thisweek");
            label4.Text = LanguageManager.Translate("Mainform_lab_yesterday");
            label2.Text = LanguageManager.Translate("Mainform_lab_today");

            button2.Text = LanguageManager.Translate("Mainform_SawBladeInfo");
            button1.Text = LanguageManager.Translate("Mainform_SawInfo");
        }
